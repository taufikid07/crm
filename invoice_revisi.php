...
while($tl = $xoopsDB->fetchArray($res_grup)){
	$group_selected = "SELECT * FROM ".$xoopsDB->prefix("crm_invoice")." AS np INNER JOIN ".$xoopsDB->prefix("crm_kontak")." AS k ON np.id_kontak = k.id_kontak WHERE np.id_kontak='".$edata['id_kontak']."' AND np.id_invoice='".$edata['id_invoice']."' ORDER BY k.nama ASC";	
	$group_s = $xoopsDB->query($group_selected);
	$selected='';
	while($gs = $xoopsDB->fetchArray($group_s)){
...
$act.='
	<tr>
		...
		<td>
			...
			<a href="q_list_unit_invoice?cq='.$cq.'" class="btn btn-primary btn-mini"><i class="icon-cogs"></i> Setting</a>
		</td>
                                 ...
                                 <div class="span8 billing-form">
                                     <div class="space10"></div>
                                         ...
                                         <div class="control-group ">
                                             ...
                                             <input name="kontak" type="hidden" class="span5" value="'.$edata['id_kontak'].'">
                                            <select name="kontak" class="span5" tabindex="1" disabled="disabled">
                                                '.$grup_client.'	
                                            </select>
                                         </div>
                                         <div class="control-group ">
                                            <label class="control-label">Use Project Name</label>
                                            <input name="kegiatan" type="hidden" class="span5" value="'.$edata['id_kegiatan'].'">
                                                <select class="span8" name="kegiatan" disabled="disabled">
                                                    <option value=""> Choose
                                                    '.$pub_kgt.'
                                                </select>
                                         </div>
                                         ...
                                         <div class="control-group ">
                                            <label class="control-label">Project Manager</label>
                                                <select style="width:220px" name="project_manager" disabled="disabled">
                                                    <option value=""> Choose
                                                    '.$group_manager.'
                                                </select>
                                         </div>
                             ...
                             <div class="row-fluid">
                                 ...
                                 <div class="span12">
                                    <div class="row-fluid text-center">
                                        <input name="codeq" type="hidden" value="'.$edata['codeq'].'">
                                        <input name="project_manager" type="hidden" value="'.$edata['project_manager'].'">
                                        <button class="btn btn-success" type="submit" name="revisi">Revisi Invoice</button>
                                     </div>
                                 </div>
                                 </form>
                             </div>
