			   ...
			   <div class="span12">
				  <!-- BEGIN PAGE TITLE & BREADCRUMB-->
				   ...
				   <ul class="breadcrumb">
					   ...
					   <li>
						  <a href="invoice_create_next?pr='.$pr.'&keg='.$keg.'&quote='.$quote.'">Create Invoice</a>
						  <span class="divider">/</span>
					   </li>
					   <li class="active">
						  Unit List
                 ...
                 <div class="widget purple">
                     <div class="widget-title">
                       ...
                       <div class="actions sm-btn-position">
                            <a href="q_create_quote?pr='.$pr.'" class="btn btn-primary btn-small"> Back <i class="icon-arrow-right"></i> </a>
                        </div>
                     </div>
