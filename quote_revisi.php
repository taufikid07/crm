                    ...
                    <div class="widget-body form">
                        ...
                        <div class="widget-body">
                         ...
                         <div class="space15"></div>
                            <form class="cmxform form-horizontal" id="commentForm" name="form_perusahaan" action="model/model_quote?pr='.$pr.'&quote='.$quote.'" method="post">
                             <div class="row-fluid">
                                 ...
                                 <div class="span8 billing-form">
                                     <div class="space10"></div>
                                         ...
                                         <div class="control-group ">
                                            ...
                                            <select name="kontak" class="span5" tabindex="1" readonly="readonly">
                                                '.$grup_client.'	
                                            </select>
                                         </div>
                                         <div class="control-group ">
                                            ...
                                            <input name="kegiatan" type="hidden" class="span5" value="'.$edata['id_kegiatan'].'">
                                                <select class="span8" name="kegiatan" readonly="readonly">
                                                    <option value=""> Choose
                                                    '.$pub_kgt.'
                                                </select>
                                         </div>
                                         ...
                                         <div class="control-group ">
                                            <label class="control-label">Project Manager</label>
                                                <select style="width:220px" name="project_manager" readonly="readonly">
                                                    <option value=""> Choose
                                                    '.$group_manager.'
                                                </select>
                                         </div>
                             ...
                             <div class="row-fluid">
                                 ...
                                 <div class="span12">
                                    <div class="row-fluid text-center">
                                        ...
                                        <button class="btn btn-success" type="submit" name="revisi">Revisi Quotation</button>
                                     </div>
                                 </div>
                                 </form>
                             </div>
