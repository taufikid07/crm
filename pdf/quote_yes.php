...
//Prepared Manager
$qpre = "SELECT u.name FROM ".$xoopsDB->prefix("users")." AS u WHERE uid='".$uid."'";	
        ...
        <table class="tabel-foothead">
            <tr>
                <td style="text-align: Center; width: 100%; z-index:1;">
					<img src="img/header.png" style="width:725px;">
				</td>
            </tr>			
        </table>
...
$cekdata = $edata['deskripsi'] == '' ? $dpr['nama_kegiatan'] : $edata['deskripsi'];
$content = $tes2;
// echo"$content";
// convert in PDF
...
try
{
	...
	$html2pdf->Output('Quotation-'.$datenow2.'-'.$cekdata.'.pdf');
}
