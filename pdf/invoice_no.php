...
//Client
$qcl = "SELECT k.nama_kontak, k.no_hp, k.email FROM ".$xoopsDB->prefix("crm_invoice")." AS np INNER JOIN ".$xoopsDB->prefix("crm_kontak")." AS k ON np.id_kontak = k.id_kontak WHERE np.id_kontak='".$edata['id_kontak']."' AND np.id_invoice='".$edata['id_invoice']."' ORDER BY k.nama ASC";
        ...
        <table class="tabel-foothead">
            <tr>
                <td style="text-align: Center; width: 100%; z-index:1;">
					<img src="img/Invoice_header_draf.png" style="width:725px;">
				</td>
            </tr>			
        </table>
